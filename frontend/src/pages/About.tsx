          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {values.map((value) => (
              <Card key={value.title} className="text-center">
                <span className="mx-auto mb-3 flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-brand-50 to-accent-400/10 text-brand-500 ring-1 ring-slate-200/70 dark:from-brand-500/10 dark:to-accent-500/5 dark:text-brand-400 dark:ring-slate-800">
