...
import { AlertCircle, Ban, CheckCircle2, Megaphone, PauseCircle, PlayCircle } from 'lucide-react'
...
export function AdminCampaignsPage() {
  ...
  return (
    <DashboardLayout>
      ...
      {campaigns?.length === 0 && <EmptyState icon={Megaphone} title="هنوز کمپینی ثبت نشده" />}
