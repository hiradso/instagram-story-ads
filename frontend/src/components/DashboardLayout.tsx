...
export function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={`flex min-h-screen bg-slate-200 dark:bg-slate-950 ${isAdmin ? 'admin-throne-bg' : ''}`}>
      {open && (
        <div
              ...
              <span className="relative flex items-center justify-center">
                ...
                <span
                  className={`relative flex size-9 items-center justify-center rounded-xl shadow-sm ${
                    isAdmin
                      ? 'bg-gradient-to-tl from-amber-500 via-yellow-400 to-amber-600 text-red-950 shadow-amber-500/40 ring-1 ring-amber-200/50'
                      : tier === 3
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2">
            <span
              className={`flex size-7 items-center justify-center rounded-lg text-white ${
                isAdmin
                  ? 'bg-gradient-to-tl from-amber-500 via-yellow-400 to-amber-600 text-red-950'
                  : 'bg-gradient-to-tl from-brand-600 via-brand-500 to-accent-500'
              }`}
            >
          ...
          <span
            className={`flex size-8 items-center justify-center rounded-full text-xs font-bold ${
              isAdmin ? 'bg-gradient-to-tl from-amber-500 to-amber-600 text-red-950' : 'bg-brand-600 text-white'
            }`}
          >
