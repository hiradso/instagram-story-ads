...
export function Card({ as: Component = 'div', children, hover = false, className = '', ...rest }: CardProps) {
  return (
    <Component
      className={`rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 transition-all duration-200 dark:bg-slate-900 dark:shadow-black/10 dark:ring-slate-800/70 ${
